...
"""
Some maps and dictionaries which can help translate values in the game's RAM
to readable info which can be used by the agent.

All info taken from the game's wiki links, with some help from ChatGPT for easy formatting.
"""
...
moves = {
    ...
    "Mimic": ["Normal", 0, 100],
    "Minimize": ["Normal", 0, 0],
    "Mirror Move": ["Flying", 50, 0],
    "Mist": ["Ice", 0, 0],
    "Night Shade": ["Ghost", 60, 100],
